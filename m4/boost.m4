...
BOOST_DEFUN([Log],
[
boost_log_save_CPPFLAGS=$CPPFLAGS
CPPFLAGS="$CPPFLAGS -DBOOST_LOG_DYN_LINK"
BOOST_FIND_LIB([log], [$1],
    [boost/log/core/core.hpp],
    [boost::log::attribute a; a.get_value();])
BOOST_CPPFLAGS="$BOOST_CPPFLAGS -DBOOST_LOG_DYN_LINK"
CPPFLAGS=$boost_log_save_CPPFLAGS
])# BOOST_LOG
